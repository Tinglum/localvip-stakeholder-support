...
async function seedFixtures() {
  ...
  await upsert('qr_codes', [
    ...
    { id: sid(81, 13), name: 'Taylor VIP Link', short_code: 'vip-taylor-26', destination_url: 'https://localvip.com/r/vip-taylor-26', redirect_url: 'https://localvip.com/r/vip-taylor-26', brand: 'localvip', foreground_color: '#1d4ed8', background_color: '#ffffff', frame_text: 'Share LocalVIP', campaign_id: null, city_id: cityByName.get('Atlanta')?.id || null, stakeholder_id: profileId('taylor@localvip.com'), business_id: null, cause_id: null, collection_id: null, destination_preset: 'referral_share', scan_count: 27, version: 1, status: 'active', created_by: profileId('taylor@localvip.com'), metadata: { source: 'seed-fixtures', audience: 'vip_client' } },
    { id: sid(81, 14), name: 'Taylor Story Link', short_code: 'vip-story-26', destination_url: 'https://localvip.com/r/vip-story-26', redirect_url: 'https://localvip.com/r/vip-story-26', brand: 'localvip', foreground_color: '#7c3aed', background_color: '#ffffff', frame_text: 'Invite Your People', campaign_id: null, city_id: cityByName.get('Atlanta')?.id || null, stakeholder_id: profileId('taylor@localvip.com'), business_id: null, cause_id: null, collection_id: null, destination_preset: 'referral_share', scan_count: 9, version: 1, status: 'active', created_by: profileId('taylor@localvip.com'), metadata: { source: 'seed-fixtures', audience: 'vip_client' } },
  ])
  await upsert('redirects', [
    ...
    { id: sid(82, 13), short_code: 'vip-taylor-26', destination_url: 'https://localvip.com/r/vip-taylor-26', qr_code_id: sid(81, 13), click_count: 27, status: 'active', created_by: profileId('taylor@localvip.com') },
    { id: sid(82, 14), short_code: 'vip-story-26', destination_url: 'https://localvip.com/r/vip-story-26', qr_code_id: sid(81, 14), click_count: 9, status: 'active', created_by: profileId('taylor@localvip.com') },
  ])
  await upsert('qr_code_events', [
    ...
    { id: sid(88, 13), qr_code_id: sid(81, 13), event_type: 'scan', city: 'Atlanta', country: 'US', metadata: { source: 'text-share' } },
    { id: sid(88, 14), qr_code_id: sid(81, 14), event_type: 'scan', city: 'Atlanta', country: 'US', metadata: { source: 'story-share' } },
  ])

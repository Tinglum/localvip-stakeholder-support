...
export function mergeCauseRecord(
  ...
  return {
    ...
    type: qaCause ? resolveCauseType(qaCause.category) : localCause!.type,
    organization_id: localCause?.organization_id || null,
    website: qaCause && 'website' in qaCause ? qaCause.website ?? null : localCause?.website || null,
    email: qaCause ? qaFields.owner_email || null : localCause?.email || null,
    phone: qaCause ? qaFields.owner_phone || null : localCause?.phone || null,

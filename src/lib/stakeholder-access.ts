...
const BUSINESS_NAV_ITEMS: NavItem[] = [
  ...
  { label: 'My Wallet', href: '/portal/wallet', icon: 'Wallet', minLevel: 0 },
  { label: 'Transactions', href: '/portal/transactions', icon: 'CreditCard', minLevel: 0 },
  { label: 'My Network', href: '/portal/network', icon: 'Users', minLevel: 0 },
  { label: 'Contributions', href: '/portal/contributions', icon: 'Heart', minLevel: 0 },
